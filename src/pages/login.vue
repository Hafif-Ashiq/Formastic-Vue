    ...
    await axios
      ...
      .then((response) => {
        ...
        if (res == 200) {
          ...
          // notyf.dismissAll()
          notyf.success('Welcome back, ' + name)

          var user_role = response.data['user']['user_role']
          if (redirect) {
            router.push(redirect)
          } else if (user_role === 'user') {
            router.push('/dashboard')
          } else if (user_role === 'admin') {
            router.push('/sidebar/dashboards/company')
          }

          console.log('log ' + userSession.isLoggedIn)
            ...
            >
              <!-- <VMessage color="primary">
                <div>
                  ...
                  <span>example.123@example.com</span>
                </div>
                <div>
                  <strong class="pr-1">password:</strong>
                  <span>examplePassword</span>
                </div>
              </VMessage> -->
              ...
              <div class="button-wrap has-help">
                ...
                <span>
                  Or
                  <RouterLink to="/signup">Create</RouterLink>
                  an account.
                </span>
              </div>
            </form>
