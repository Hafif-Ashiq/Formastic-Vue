...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    '/forms/create-form/': RouteRecordInfo<'/forms/create-form/', '/forms/create-form', Record<never, never>, Record<never, never>>,
    '/forms/create-form/[id]/': RouteRecordInfo<'/forms/create-form/[id]/', '/forms/create-form/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    '/forms/responses/': RouteRecordInfo<'/forms/responses/', '/forms/responses', Record<never, never>, Record<never, never>>,
    '/forms/responses/[id]/': RouteRecordInfo<'/forms/responses/[id]/', '/forms/responses/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    '/login': RouteRecordInfo<'/login', '/login', Record<never, never>, Record<never, never>>,
    '/navbar': RouteRecordInfo<'/navbar', '/navbar', Record<never, never>, Record<never, never>>,
    '/response/': RouteRecordInfo<'/response/', '/response', Record<never, never>, Record<never, never>>,
    '/response/[id]/': RouteRecordInfo<'/response/[id]/', '/response/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
